...
> Đối với thế hệ trẻ (Gen Z & Millennials), việc đi tập gym không chỉ vì sức khỏe mà còn vì ngoại hình và sự tự tin, nhưng chi phí thuê PT lại là một rào cản quá lớn. Cơ hội ở đây là dân chủ hóa (democratize) việc huấn luyện cá nhân bằng một "PT ảo bỏ túi": tự động hóa sự an toàn và loại bỏ cảm giác "quê" khi tập sai bằng phản hồi âm thanh (audio cues) thời gian thực ngay trong lúc nâng tạ.
...
|---|---|---|---|
| TAM | ~$25M - $35M/year | Toàn bộ quy mô dân số trẻ (16-30) quan tâm đến fitness/gym tự do tại Việt Nam có smartphone. | med |
| SAM | ~$5M - $8M/year | Người trẻ (16-28 tuổi) tại các đô thị lớn, tập tại các chuỗi gym bình dân/phòng tập sinh viên. | med |
| SOM | 15,000 paid users (~$450K - $700K) | Đạt được trong 12-18 tháng đầu bằng cách đánh vào các cộng đồng trường Đại học và hợp tác Micro-Influencer (GymTok). | low |
...
3. Cách thiết kế mô hình Freemium thế nào để thu hút tệp 16-22 tuổi nhưng vẫn kiếm được tiền từ tệp 23-28 tuổi?](https://github.com/d4ng4nh/day16)
